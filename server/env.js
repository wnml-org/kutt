...
const spec = {
  ...
  DB_IAM_REGION: str({ example: "us-east-1", default: "" }),
  REDIS_ENABLED: bool({ default: false }),
  REDIS_HOST: str({ default: "127.0.0.1" }),
  REDIS_PORT: num({ default: 6379 }),
  REDIS_PASSWORD: str({ default: "" }),
  REDIS_DB: num({ example: 9, default: 0 }),
  REDIS_TLS_ENABLED: bool({ default: false }),
  REDIS_TLS_CA: str({ desc: "PEM encoded CA certificate", default: "" }),
  REDIS_TLS_CERT: str({ desc: "PEM encoded client certificate", default: "" }),
  REDIS_TLS_KEY: str({ desc: "PEM encoded client key", default: "" }),
